...
export const POOL_REGISTRY: PoolRegistryEntry[] = [
  { id: 'crvusd', stablecoin: 'crvUSD', name: 'frxUSD / crvUSD', partner: 'Curve Finance', partnerInitials: 'CV', partnerColor: '#00ff88', description: 'Overcollateralized stablecoin by Curve', chain: 'Ethereum', since: '2024-12', dlSymbols: ['FRXUSD-CRVUSD', 'CRVUSD-FRXUSD'], duneTvlFallback: 27_426_137, duneFrxUsdTvlFallback: 12_180_446, curveUrl: 'https://curve.fi' },
